...
```{r}
sur.int.dur <- update(out.dur.slp, .~. + Surprise)
sur.slp.dur <- update(sur.int.dur, random = ~ 1 + OutsideDuration + Surprise|SubjectNo)
anova(out.dur.slp, sur.int.dur, sur.slp.dur)
```
...
pre.out.dur.slp <- update(pre.out.dur.int, random = ~ 1 + OutsideDuration|SubjectNo)

pre.sur.int.dur <- update(pre.out.dur.slp, .~. + PreSur)
pre.sur.slp.dur <- update(pre.sur.int.dur, random = ~ 1 + OutsideDuration + PreSur|SubjectNo)

```

```{r}
anova(pre.baseline, pre.out.dur.int, pre.out.dur.slp, pre.sur.int.dur, pre.sur.slp.dur)
```
