...
```{r, echo = FALSE, message=FALSE, warning=FALSE}
# load("~/Documents/OneDrive - Cardiff University/ProjectsVRCuriosityMemory/PilotData/RawData/Pilot_02/.RData")
...
anova(order.model.linear.1, order.model.linear.2, order.model.quad.1, order.model.quad.2, novelty.model.1, novelty.model.2, novelty.model.3)
```
