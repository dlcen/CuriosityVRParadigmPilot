...
```
For both *familiar* and *novel* rooms, the hit rate seems to be higher at the two ends as compared to the middle. `r text_spec("Note that we now have 29 participants here", background = "#D05A6E", color = "white", bold = T, font_size = 15)`. 
