...
ggplot(OutsideObjectsMemory[!SubjectNo %in% bad.ps.less.strict, .(MeanContextAccuracy = mean(ContextAccuracy)), by = c("SubjectNo", "Group")], aes(x = Group, y = MeanContextAccuracy)) +
...
```{r, echo = FALSE}
t.test(MeanContextAccuracy ~ Group, data = OutsideObjectsMemory[!SubjectNo %in% bad.ps.less.strict, .(MeanContextAccuracy = mean(ContextAccuracy)), by = c("SubjectNo", "Group")], paired = TRUE)
```
We had 27 good participants.
...
ggplot(Curiosity.Recall.Old[!SubjectNo %in% bad.ps.less.strict], aes(x = ItemOrder, y = ContextAccuracy)) +
...
```{r, echo = FALSE}
baseline.context <- lme(ContextAccuracy ~ 1, random = ~ 1|SubjectNo/Group, data = Curiosity.Recall.Old[!SubjectNo %in% bad.ps.less.strict], method = "ML", control = list(msMaxIter = 500, opt = "optim", msVerbose=FALSE), na.action = na.exclude)
...
ggplot(Curiosity.Recall.Old.Collapsed.Grp[!SubjectNo %in% bad.ps.less.strict], aes(x = Group, y = ContextAccuracy)) +
...
#### Stats on it
```{r, echo = FALSE}
repeatedModel <- lme(ContextAccuracy ~ Group * ItemOrderType, random = ~ 1| SubjectNo/Group/ItemOrderType, data = Curiosity.Recall.Old.Collapsed.Grp[!SubjectNo %in% bad.ps.less.strict], method = "ML", control = list(msMaxIter = 500, opt = "optim", msVerbose=FALSE))
...
```{r}
t.test(ContextAccuracy ~ Group, data = Curiosity.Recall.Old.Collapsed.Grp[!SubjectNo %in% bad.ps.less.strict & ItemOrderType == "Early"], paired = T)
```

##### Simple effects in "Late"
```{r}
t.test(ContextAccuracy ~ Group, data = Curiosity.Recall.Old.Collapsed.Grp[!SubjectNo %in% bad.ps.less.strict & ItemOrderType == "Late"], paired = T)
```
...
ggplot(OutsideObjectsMemory[!SubjectNo %in% bad.ps.less.strict], aes(x = CuriosityRating, y = ContextAccuracy)) +
...
```{r, echo = FALSE}
baseline.rating <- lme(ContextAccuracy ~ 1, random = ~ 1|SubjectNo, data = OutsideObjectsMemory[!SubjectNo %in% bad.ps.less.strict], method = "ML", control = list(msMaxIter = 500, opt = "optim", msVerbose=FALSE), na.action = na.exclude)
...
ggplot(Curiosity.Recall.Old[!SubjectNo %in% bad.ps.less.strict], aes(x = CuriosityRating, y = ContextAccuracy)) +
...
```{r}
baseline.context <- lme(ContextAccuracy ~ 1, random = ~ 1|SubjectNo, data = Curiosity.Recall.Old[!SubjectNo %in% bad.ps.less.strict], method = "ML", control = list(msMaxIter = 500, opt = "optim", msVerbose=FALSE), na.action = na.exclude)
...
```{r, echo=FALSE, fig.align='center', fig.width=4.2, fig.height=3.6, fig.cap='Figure 7. Mean hit rate as a function of item order (Early vs. Late) and curiosity (Low vs. High).'}
ggplot(Curiosity.Recall.Old.Collapsed[!SubjectNo %in% bad.ps.less.strict], aes(x = CuriosityRatingType, y = ContextAccuracy)) +
  stat_summary(fun.y = mean, geom = "bar", size = 2, fill = "grey50") +
  stat_summary(fun.data = mean_cl_normal, geom = "errorbar", width = 0.2, position = position_dodge(width = 0.9)) +
  labs(x = "Curiosity rating", y = "Mean accuracy for context memory") +
  facet_wrap( ~ ItemOrderType, nrow = 1) +
...
#### Stats on it
```{r, echo = FALSE}
repeatedModel <- lme(ContextAccuracy ~ CuriosityRatingType * ItemOrderType, random = ~1| SubjectNo/CuriosityRatingType/ItemOrderType, data = Curiosity.Recall.Old.Collapsed[!SubjectNo %in% bad.ps.less.strict], method = "ML", control = list(msMaxIter = 500, opt = "optim", msVerbose=FALSE))
...
temp.table <- as.data.frame(with(Curiosity.Recall.Old.Collapsed, table( SubjectNo, CuriosityRatingType)))
temp.table <- data.table(temp.table)
single.sbjs <- as.character(temp.table[CuriosityRatingType == "Low" & Freq < 2]$SubjectNo)

t.test(ContextAccuracy ~ CuriosityRatingType, data = Curiosity.Recall.Old.Collapsed[!SubjectNo %in% c(bad.ps.less.strict, single.sbjs) & ItemOrderType == "Early"], paired = T, na.rm = T)
```

##### Simple effects in "Late"
```{r}
t.test(ContextAccuracy ~ CuriosityRatingType, data = Curiosity.Recall.Old.Collapsed[!SubjectNo %in% c(bad.ps.less.strict, single.sbjs) & ItemOrderType == "Late"], paired = T)
```
...
ggplot(Curiosity.Recall.Old.Collapsed.Alt.Cur[!SubjectNo %in% bad.ps.less.strict], aes(x = RatingGroup, y = ContextAccuracy)) +
  stat_summary(fun.y = mean, geom = "bar") +
  stat_summary(fun.data = mean_cl_boot, geom = "errorbar", width = 0.2) +
...
```{r, echo = FALSE}
t.test(ContextAccuracy ~ RatingGroup, data = Curiosity.Recall.Old.Collapsed.Alt.Cur[!SubjectNo %in% bad.ps.less.strict], paired = T)
```

```{r, echo=FALSE, fig.align='center', fig.width=4.2, fig.height=3.6}
ggplot(Curiosity.Recall.Old.Collapsed.Alt[!SubjectNo %in% bad.ps.less.strict], aes(x = RatingGroup, y = ContextAccuracy)) +
  stat_summary(fun.y = mean, geom = "bar", size = 2, fill = "grey50") +
  stat_summary(fun.data = mean_cl_normal, geom = "errorbar", width = 0.2, position = position_dodge(width = 0.9)) +
  labs(x = "Curiosity rating", y = "Mean accuracy for context memory") +
  facet_wrap( ~ ItemOrderType, nrow = 1) +
...
#### Stats on it
```{r, echo = FALSE}
repeatedModel <- lme(ContextAccuracy ~ RatingGroup * ItemOrderType, random = ~ 1| SubjectNo/RatingGroup/ItemOrderType, data = Curiosity.Recall.Old.Collapsed.Alt[!SubjectNo %in% bad.ps.less.strict], method = "ML", control = list(msMaxIter = 500, opt = "optim", msVerbose=FALSE))
...
##### Simple effects in "Early"
```{r}
t.test(ContextAccuracy ~ RatingGroup, data = Curiosity.Recall.Old.Collapsed.Alt[!SubjectNo %in% c(bad.ps.less.strict) & ItemOrderType == "Early"], paired = T)
```

##### Simple effects in "Late"
```{r}
t.test(ContextAccuracy ~ RatingGroup, data = Curiosity.Recall.Old.Collapsed.Alt[!SubjectNo %in% c(bad.ps.less.strict) & ItemOrderType == "Late"], paired = T)
```
...
``` {r, echo = FALSE}
baseline.rating <- lme(ContextAccuracy ~ 1, random = ~ 1|SubjectNo/Group, data = OutsideObjectsMemory[!SubjectNo %in% bad.ps.less.strict], method = "ML", control = list(msMaxIter = 500, opt = "optim", msVerbose=FALSE), na.action = na.exclude)
...
```{r, echo=FALSE, fig.align='center', fig.width=4.2, fig.height=3.6}
ggplot(Curiosity.Recall.Old.Collapsed.Interaction[!SubjectNo %in% bad.ps.less.strict], aes(x = CuriosityRatingType, y = ContextAccuracy)) +
  stat_summary(fun.y = mean, geom = "bar", size = 2, fill = "grey50") +
...
#### Stats on it
```{r, echo = FALSE}
interactionModel <- lme(ContextAccuracy ~ CuriosityRatingType * Group, random = ~ 1| SubjectNo/CuriosityRatingType/Group, data = Curiosity.Recall.Old.Collapsed.Interaction[!SubjectNo %in% bad.ps.less.strict], method = "ML", control = list(msMaxIter = 500, opt = "optim", msVerbose=FALSE))
...
```{r, echo=FALSE, fig.align='center', fig.width=4.2, fig.height=3.6}
ggplot(Curiosity.Recall.Old.Collapsed.Alt.Interaction[!SubjectNo %in% bad.ps.less.strict], aes(x = RatingGroup, y = ContextAccuracy)) +
  stat_summary(fun.y = mean, geom = "bar", size = 2, fill = "grey50") +
  stat_summary(fun.data = mean_cl_boot, geom = "errorbar", width = 0.2, position = position_dodge(width = 0.9)) +
  labs(x = "Curiosity rating", y = "Mean accuracy for context memory") +
  facet_wrap( ~ Group, nrow = 1) +
...
```{r, echo = FALSE}
interactionModel <- lme(ContextAccuracy ~ RatingGroup * Group, random = ~ 1| SubjectNo/RatingGroup/Group, data = Curiosity.Recall.Old.Collapsed.Alt.Interaction[!SubjectNo %in% bad.ps.less.strict], method = "ML", control = list(msMaxIter = 500, opt = "optim", msVerbose=FALSE))
...
```{r, echo=FALSE, fig.align='center', fig.width=3.6, fig.height=3}
ggplot(OutsideObjectsMemory[!SubjectNo %in% bad.ps.less.strict & Group == "Novel"], aes(x = CuriosityRating, y = ContextAccuracy)) +
  stat_summary(fun.data = mean_cl_boot, na.rm = T, geom = "errorbar", width = 0.2) +
  stat_summary(fun.y = mean, na.rm = T, geom = "point", size = 2) +
  stat_smooth(method = "lm", se = FALSE) +
  scale_x_continuous(breaks = c(1:7)) +
...
#### Building models
```{r, echo = FALSE}
baseline.rating <- lme(ContextAccuracy ~ 1, random = ~ 1|SubjectNo, data = OutsideObjectsMemory[!SubjectNo %in% bad.ps.less.strict & Group == "Novel"], method = "ML", control = list(msMaxIter = 500, opt = "optim", msVerbose=FALSE), na.action = na.exclude)
