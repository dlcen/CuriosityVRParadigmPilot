...
```{r, echo = FALSE, message=FALSE, warning=FALSE}
library(data.table); library(ggplot2); library(nlme); library(multcomp)
```
...
```{r Find out bad participants, echo=FALSE, include=FALSE, eval=FALSE}
bad.ps <- NULL
...
ggplot(OutsideObjectsMemory[, .(MeanCorrSeenHit = mean(CorrSeenHit)), by = c("SubjectNo", "Group")], aes(x = Group, y = MeanCorrSeenHit)) +
...
```{r, echo = FALSE}
t.test(MeanCorrSeenHit ~ Group, data = OutsideObjectsMemory[, .(MeanCorrSeenHit = mean(CorrSeenHit)), by = c("SubjectNo", "Group")], paired = TRUE)
```
...
ggplot(Curiosity.Recall.Old.Novelty, aes(x = ItemOrder, y = CorrSeenHit)) +
...
```{r, echo = FALSE}
baseline.item <- lme(CorrSeenHit ~ 1, random = ~ 1|SubjectNo/Group, data = Curiosity.Recall.Old.Novelty, method = "ML", control = list(msMaxIter = 500, opt = "optim", msVerbose=FALSE), na.action = na.exclude)
...
ggplot(Curiosity.Recall.Old.Order.Novelty, aes(x = Group, y = CorrSeenHit)) +
...
##### Using `lme`
```{r, echo = FALSE}
baseline      <- lme(CorrSeenHit ~ 1, random = ~1|SubjectNo/Group/ItemOrderType, data = Curiosity.Recall.Old.Order.Novelty, method = "ML")
...
``` {r, echo = FALSE}
summary(OrderModel)$tTable
```
Only a main effect of item order.
...
ggplot(OutsideObjectsMemory, aes(x = CuriosityRating, y = CorrSeenHit)) +
...
```{r, echo = FALSE}
baseline.rating <- lme(CorrSeenHit ~ 1, random = ~ 1|SubjectNo, data = OutsideObjectsMemory, method = "ML", control = list(msMaxIter = 500, opt = "optim", msVerbose=FALSE), na.action = na.exclude)
...
ggplot(Curiosity.Recall.Old.CuriosityRating, aes(x = CuriosityRating, y = CorrSeenHit)) +
...
```{r}
baseline.item <- lme(CorrSeenHit ~ 1, random = ~ 1|SubjectNo, data = Curiosity.Recall.Old.CuriosityRatingN, method = "ML", control = list(msMaxIter = 500, opt = "optim", msVerbose=FALSE), na.action = na.exclude)
...
ggplot(Curiosity.Recall.Old.Order.CuriosityType, aes(x = CuriosityRatingType, y = CorrSeenHit)) +
  stat_summary(fun.y = mean, geom = "bar", size = 2, fill = "grey50") +
  stat_summary(fun.data = mean_cl_normal, geom = "errorbar", width = 0.2, position = position_dodge(width = 0.9)) +
...
#### Stats on it
```{r, echo = FALSE}
baseline <- lme(CorrSeenHit ~ 1, random = ~ 1| SubjectNo/CuriosityRatingType/ItemOrderType, data = Curiosity.Recall.Old.Order.CuriosityType, method = "ML", control = list(msMaxIter = 500, opt = "optim", msVerbose=FALSE))

curiosityModel <- update(baseline, .~. + CuriosityRatingType)
OrderModel     <- update(curiosityModel, .~. + ItemOrderType)
interactModel  <- update(OrderModel,     .~. + CuriosityRatingType : ItemOrderType)

anova(baseline, curiosityModel, OrderModel, interactModel)
```

Just a main effect of item order.

#### Linear trend respectivley for High and Low curiosity groups
```{r, echo = FALSE, fig.align= 'center', fig.width=4.8, fig.height=3.6}
ggplot(Curiosity.Recall.Old.CuriosityType, aes(x = ItemOrder, y = CorrSeenHit)) + theme_classic() +
...
ggplot(Curiosity.Recall.Old.Collapsed.CuriosityType.MeanSep, aes(x = RatingGroup, y = CorrSeenHit)) +
  stat_summary(fun.y = mean, geom = "bar") +
  stat_summary(fun.data = mean_cl_boot, geom = "errorbar", width = 0.2) +
...
```{r, echo = FALSE}
t.test(CorrSeenHit ~ RatingGroup, data = Curiosity.Recall.Old.Collapsed.CuriosityType.MeanSep, paired = T)
```

```{r, echo=FALSE, fig.align='center', fig.width=4.2, fig.height=3.6}
ggplot(Curiosity.Recall.Old.Order.CuriosityType.MeanSep, aes(x = RatingGroup, y = CorrSeenHit)) +
  stat_summary(fun.y = mean, geom = "bar", size = 2, fill = "grey50") +
  stat_summary(fun.data = mean_cl_normal, geom = "errorbar", width = 0.2, position = position_dodge(width = 0.9)) +
...
#### Stats on it
```{r, echo = FALSE}
baseline <- lme(CorrSeenHit ~ 1, random = ~ 1| SubjectNo/RatingGroup/ItemOrderType, data = Curiosity.Recall.Old.Order.CuriosityType.MeanSep, method = "ML", control = list(msMaxIter = 500, opt = "optim", msVerbose=FALSE))

curiosityModel <- update(baseline, .~. + RatingGroup)
OrderModel     <- update(curiosityModel, .~. + ItemOrderType)
interactModel  <- update(OrderModel,     .~. + RatingGroup : ItemOrderType)
...
#### Linear trend respectivley for High and Low curiosity groups
```{r, echo = FALSE, fig.align= 'center', fig.width=4.8, fig.height=3.6}
ggplot(Curiosity.Recall.Old.CuriosityType.MeanSep, aes(x = ItemOrder, y = CorrSeenHit)) + theme_classic() +
...
##### Stats
```{r, echo = FALSE}
baseline          <- lme(CorrSeenHit ~ 1, random = ~ 1| SubjectNo/RatingGroup, data = Curiosity.Recall.Old.CuriosityType.MeanSep, method = "ML", control = list(msMaxIter = 500, opt = "optim", msVerbose=FALSE))

order.model.1     <- update(baseline,     .~. + ItemOrder)
order.model.2     <- update(order.model.1, random = ~1 + ItemOrder|SubjectNo/RatingGroup)

cur.model         <- update(order.model.2, .~. + RatingGroup)
inter.model       <- update(cur.model,     .~. + RatingGroup : ItemOrder)

anova(baseline, order.model.1, order.model.2, cur.model, inter.model)
```
...
```{r, echo = FALSE}
baseline.rating <- lme(CorrSeenHit ~ 1, random = ~ 1|SubjectNo/Group, data = OutsideObjectsMemory, method = "ML", control = list(msMaxIter = 500, opt = "optim", msVerbose=FALSE), na.action = na.exclude)
...
```{r, echo=FALSE, fig.align='center', fig.width=4.2, fig.height=3.6}
ggplot(Curiosity.Recall.Old.Interaction, aes(x = CuriosityRatingType, y = CorrSeenHit)) +
  stat_summary(fun.y = mean, geom = "bar", size = 2, fill = "grey50") +
  stat_summary(fun.data = mean_cl_normal, geom = "errorbar", width = 0.2, position = position_dodge(width = 0.9)) +
  labs(x = "Curiosity rating", y = "Hit rate for recollection") +
...
```{r, echo=FALSE, fig.align='center', fig.width=4.2, fig.height=3.6}
ggplot(Curiosity.Recall.Old.Interaction.MeanSep, aes(x = RatingGroup, y = CorrSeenHit)) +
  stat_summary(fun.y = mean, geom = "bar", size = 2, fill = "grey50") +
