...
inside.hit.rate.per.room <- inside.hit.rate.per.room[SAcc >= 0 & SrcAcc >= 0]
outside.hit.rate.per.room <- outside.hit.rate.per.room[SAcc >= 0 & SrcAcc >= 0]
```
...
outside.hit.rate.trait.diff$diffSAcc     <- outside.hit.rate.trait.novel$meanSAcc - outside.hit.rate.trait.familiar[SubjectNo %in% as.character(unique(outside.hit.rate.trait.novel$SubjectNo))]$meanSAcc 
outside.hit.rate.trait.diff$diffSrcAcc   <- outside.hit.rate.trait.novel$meanSrcAcc - outside.hit.rate.trait.familiar[SubjectNo %in% as.character(unique(outside.hit.rate.trait.novel$SubjectNo))]$meanSrcAcc
outside.hit.rate.trait.diff$diffRating   <- outside.hit.rate.trait.novel$meanCurRating - outside.hit.rate.trait.familiar[SubjectNo %in% as.character(unique(outside.hit.rate.trait.novel$SubjectNo))]$meanCurRating
